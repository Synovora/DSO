...
Public Class FTraitementFenetreTh
    ...
    Private Sub TraitementFenetreTherapeutique_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        InitZone()
        ChargementEtatCivil()
    ...
    Private Sub BtnValidationFenetreTherapeutique_Click(sender As Object, e As EventArgs) Handles BtnValidationFenetre.Click
    ...
    Private Sub BtnSupprimerFenetreTherapeutique_Click(sender As Object, e As EventArgs) Handles BtnSupprimerFenetre.Click
        ...
        If dateCreationaComparer = dateJouraComparer Then
            ...
            End If
        Else
            MessageBox.Show("Suppression impossible, une fenêtre thérapeutique en cours ne peut être supprimée que si sa création à été réalisé dans la journée" + vbCrLf + vbCrLf + "=> Solution : arrêter le traitement ou demander l'aide d'un Admin")
        End If
    End Sub
    ...
    Private Function MajFenetreTherapeutique() As Boolean
        ...
        If (DateFenetreDebutaComparer < dateJouraComparer) Then
            ...
            Result = MessageBox.Show(Me, "Attention, la date de début de la fenêtre thérapeutique est inférieure à la date du jour, merci de confirmer", "Validation date de début de fenêtre thérapeutique", MessageBoxButtons.YesNo)
        ...
        Dim SQLstring As String = "update oasis.oa_traitement set oa_traitement_identifiant_modification = @utilisateurModification, oa_traitement_ordre_affichage = @ordreAffichage, oa_traitement_date_modification = @dateModification, oa_traitement_fenetre = @fenetreExiste, oa_traitement_fenetre_commentaire = @fenetreCommentaire, oa_traitement_fenetre_date_debut = @dateFenetreDebut, oa_traitement_fenetre_date_fin = @dateFenetreFin where oa_traitement_id = @traitementId;"
    ...
    Private Function SuppressionFenetreTherapeutique() As Boolean
        ...
        Dim SQLstring As String = "update oasis.oa_traitement set oa_traitement_identifiant_modification = @utilisateurModification, oa_traitement_date_modification = @dateModification, oa_traitement_fenetre_commentaire = @fenetreCommentaire, oa_traitement_fenetre = @fenetreExiste, oa_traitement_fenetre_date_debut = @datefenetreDebut, oa_traitement_fenetre_date_fin = @datefenetreFin where oa_traitement_id = @traitementId"
    ...
    Private Sub InhiberZonesDeSaisie()
        BtnSupprimerFenetre.Visible = False
        BtnValidationFenetre.Visible = False
