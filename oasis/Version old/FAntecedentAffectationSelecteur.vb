...
Public Class FAntecedentAffectationSelecteur
    ...
    Private Sub FAntecedentAffectationSelecteur_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        BtnConfirmer.Hide()
        ChargementEtatCivil()
    ...
    Private Sub ChargementAntecedent()
        ...
        For i = 0 To rowCount Step 1
            ...
            If antecedentDataTable.Rows(i)("oa_antecedent_ordre_affichage1") IsNot DBNull.Value Then
                AntecedentDataGridView("ordreAffichage1", iGrid).Value = antecedentDataTable.Rows(i)("oa_antecedent_ordre_affichage1")
            Else
                AntecedentDataGridView("ordreAffichage1", iGrid).Value = 0
            End If

            If antecedentDataTable.Rows(i)("oa_antecedent_ordre_affichage2") IsNot DBNull.Value Then
                AntecedentDataGridView("ordreAffichage2", iGrid).Value = antecedentDataTable.Rows(i)("oa_antecedent_ordre_affichage2")
            Else
                AntecedentDataGridView("ordreAffichage2", iGrid).Value = 0
            End If

            AntecedentDataGridView("antecedentId", iGrid).Value = antecedentDataTable.Rows(i)("oa_antecedent_id")

            AntecedentDataGridView("niveau", iGrid).Value = niveau

            AntecedentDataGridView("antecedentIdNiveau1", iGrid).Value = AntecedentIdNiveau1
        Next
    ...
    Private Sub BtnConfirmer_Click(sender As Object, e As EventArgs) Handles BtnConfirmer.Click
        ...
        antecedentIdSelected = AntecedentDataGridView.Rows(AntecedentDataGridView.CurrentRow.Index).Cells("antecedentId").Value
        ordre1AntecedentSelected = AntecedentDataGridView.Rows(AntecedentDataGridView.CurrentRow.Index).Cells("ordreAffichage1").Value
        ordre2AntecedentSelected = AntecedentDataGridView.Rows(AntecedentDataGridView.CurrentRow.Index).Cells("ordreAffichage2").Value
        NiveauAntecedentSelected = CInt(AntecedentDataGridView.Rows(AntecedentDataGridView.CurrentRow.Index).Cells("niveau").Value)
        antecedentIdNiveau1 = AntecedentDataGridView.Rows(AntecedentDataGridView.CurrentRow.Index).Cells("antecedentIdNiveau1").Value
