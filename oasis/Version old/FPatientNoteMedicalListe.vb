...
Public Class FPatientNoteMedicalListe
    ...
    Private Sub ChargementnotePatient()
        ...
        SQLString = "select * from oasis.oa_patient_note_medicale where (oa_patient_note_invalide = '0' or oa_patient_note_invalide is Null) and oa_patient_id = " + SelectedPatient.patientId.ToString + " order by oa_patient_note_date_creation desc;"
    ...
    Private Sub NotePatientDataGridView_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles NotePatientDataGridView.CellDoubleClick
        If NotePatientDataGridView.CurrentRow IsNot Nothing Then
            ...
            Dim vFPatientNoteMedicalDetailEdit As New FPatientNoteMedicalDetailEdit
            vFPatientNoteMedicalDetailEdit.SelectedNoteId = NoteId
            vFPatientNoteMedicalDetailEdit.SelectedPatient = Me.SelectedPatient
            vFPatientNoteMedicalDetailEdit.UtilisateurConnecte = Me.UtilisateurConnecte

            vFPatientNoteMedicalDetailEdit.ShowDialog() 'Modal
            If vFPatientNoteMedicalDetailEdit.CodeRetour = True Then
                NotePatientDataGridView.Rows.Clear()
                ChargementnotePatient()
            End If

            vFPatientNoteMedicalDetailEdit.Dispose()
        End If
    End Sub
    ...
    Private Sub CréerUneNoteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CréerUneNoteToolStripMenuItem.Click
        Dim vFPatientNoteMedicalDetailEdit As New FPatientNoteMedicalDetailEdit
        vFPatientNoteMedicalDetailEdit.SelectedNoteId = 0
        vFPatientNoteMedicalDetailEdit.SelectedPatient = Me.SelectedPatient
        vFPatientNoteMedicalDetailEdit.UtilisateurConnecte = Me.UtilisateurConnecte
