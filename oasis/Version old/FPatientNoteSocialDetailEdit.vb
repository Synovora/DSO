...
Public Class FPatientNoteSocialDetailEdit
    ...
    Private Sub ChargementNoteExistante()
        ...
        Dim conxn As New SqlConnection(getConnectionString())
        Dim SQLString As String = "select * from oasis.oa_patient_note_social where oa_patient_note_id = " & SelectedNoteId & ";"
    ...
    Private Function ModificationNote() As Boolean
        ...
        Dim SQLstring As String = "update oasis.oa_patient_note_social set oa_patient_note_date_modification = @dateModification, oa_patient_note_utilisateur_modification = @utilisateurModification, oa_patient_note = @note where oa_patient_note_id = @noteId"
    ...
    Private Function CreationNote() As Boolean
        ...
        Dim SQLstring As String = "insert into oasis.oa_patient_note_social (oa_patient_id, oa_patient_note, oa_patient_note_utilisateur_creation, oa_patient_note_date_creation) VALUES (@patientId, @note, @utilisateurCreation, @dateCreation)"
    ...
    Private Function AnnulationNotePatient() As Boolean
        ...
        Dim SQLstring As String = "update oasis.oa_patient_note_social set oa_patient_note_date_modification = @dateModification, oa_patient_note_utilisateur_modification = @utilisateurModification, oa_patient_note_invalide = @invalide where oa_patient_note_id = @noteId"
