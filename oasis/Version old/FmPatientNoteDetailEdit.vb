...
Public Class FmPatientNoteDetailEdit
    ...
    Private Sub FmPatientNoteDetailEdit_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ChargementEtatCivil()
    ...
    Private Sub ChargementNoteExistante()
        ...
        If NoteDataReader.Read() Then
            ...
            If NoteDataReader("oa_patient_note") Is DBNull.Value Then
                RadTxtNote.Text = ""
            Else
                RadTxtNote.Text = NoteDataReader("oa_patient_note")
            End If
    ...
    Private Function ModificationNote() As Boolean
        ...
        With cmd.Parameters
            ...
            .AddWithValue("@note", RadTxtNote.Text)
