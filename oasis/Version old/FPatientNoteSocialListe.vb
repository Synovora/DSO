...
Public Class FPatientNoteSocialListe
    ...
    Private Sub ChargementnotePatient()
        ...
        SQLString = "select * from oasis.oa_patient_note_social where (oa_patient_note_invalide = '0' or oa_patient_note_invalide is Null) and oa_patient_id = " + SelectedPatient.patientId.ToString + " order by oa_patient_note_date_creation desc;"
    ...
    Private Sub NotePatientDataGridView_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles NotePatientDataGridView.CellDoubleClick
        If NotePatientDataGridView.CurrentRow IsNot Nothing Then
            ...
            Dim vFPatientNoteSocialDetailEdit As New FPatientNoteSocialDetailEdit
            vFPatientNoteSocialDetailEdit.SelectedNoteId = NoteId
            vFPatientNoteSocialDetailEdit.SelectedPatient = Me.SelectedPatient
            vFPatientNoteSocialDetailEdit.UtilisateurConnecte = Me.UtilisateurConnecte

            vFPatientNoteSocialDetailEdit.ShowDialog() 'Modal
            If vFPatientNoteSocialDetailEdit.CodeRetour = True Then
                NotePatientDataGridView.Rows.Clear()
                ChargementnotePatient()
            End If

            vFPatientNoteSocialDetailEdit.Dispose()
        End If
    End Sub
    ...
    Private Sub CréerUneNoteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CréerUneNoteToolStripMenuItem.Click
        Dim vFPatientNoteSocialDetailEdit As New FPatientNoteSocialDetailEdit
        vFPatientNoteSocialDetailEdit.SelectedNoteId = 0
        vFPatientNoteSocialDetailEdit.SelectedPatient = Me.SelectedPatient
        vFPatientNoteSocialDetailEdit.UtilisateurConnecte = Me.UtilisateurConnecte
