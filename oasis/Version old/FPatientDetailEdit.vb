...
Public Class FPatientDetailEdit
    ...
    Private Sub FPatientDetailEdit_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If SelectedPatientId <> 0 Then
            ...
            BtnValidationDateNaissance.Hide()
            ChargementPatient()
        ...
        Else
            ...
            NotePatientDataGridView.Hide()
            NoteContextMenuStrip.Enabled = False
            Me.Width = 590
            'CréerUneNoteToolStripMenuItem.Enabled = False
        End If
    End Sub
    ...
    Private Sub ChargementNotesPatient()
        ...
        SQLString = "select * from oasis.oa_patient_note where (oa_patient_note_invalide = '0' or oa_patient_note_invalide is Null) and oa_patient_id = " + SelectedPatient.patientId.ToString + " order by oa_patient_note_date_creation desc;"
    ...
    Private Sub BtnGoogleMaps_Click(sender As Object, e As EventArgs) Handles BtnGoogleMaps.Click
    ...
    Private Sub BtnModifier_Click(sender As Object, e As EventArgs) Handles BtnModifier.Click
        ActiverZoneEnSaisie()
        BtnSortieOasis.Enabled = False
        BtnValider.Enabled = True
        BtnModifier.Enabled = False
    End Sub

    'Appel saisie sortie Oasis
    Private Sub BtnSortieOasis_Click(sender As Object, e As EventArgs) Handles BtnSortieOasis.Click
        BtnSortieOasis.Hide()
        GbxSortieOasis.Show()
        InhiberZoneEnSaisie()
        BtnModifier.Enabled = False
    ...
    Private Sub BtnValidationSortie_Click(sender As Object, e As EventArgs) Handles BtnValidationSortie.Click
    ...
    Private Sub NotePatientDataGridView_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles NotePatientDataGridView.CellDoubleClick
        If NotePatientDataGridView.CurrentRow IsNot Nothing Then
            ...
            Dim vFNotePatientDetailEdit As New FPatientNoteDetailEdit
    ...
    Private Sub BtnValidationDateNaissance_Click(sender As Object, e As EventArgs) Handles BtnValidationDateNaissance.Click
        If EditMode = EnumEditMode.Creation Then
            If DteDateNaissance.Value <> DteDateNaissance.MinDate Then
