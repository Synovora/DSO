...
Public Class FAntecedentOrdreSelecteur
    ...
    Private Sub BtnConfirmer_Click(sender As Object, e As EventArgs) Handles BtnConfirmer.Click
        ...
        NouveauOrdreAffichage = CInt(AntecedentDataGridView.Rows(AntecedentDataGridView.CurrentRow.Index).Cells("ordreAffichage").Value) + 10
        'MessageBox.Show("Nouvel ordre d'affichage : " & NouveauOrdreAffichage.ToString("0000"))

        'Ajout ligne présente dans l'entête
        AntecedentDataGridView.Rows.Add(TxtAntecedentAOrdonner.Text, NouveauOrdreAffichage.ToString, AntecedentIdaOrdonner.ToString)
        iGridMax += 1

        'AntecedentDataGridView.Sort(AntecedentDataGridView.Columns("ordreAffichage"), System.ComponentModel.ListSortDirection.Ascending)
    ...
    Private Function AntecedentModificationOrdre() As Boolean
        ...
        For i = 0 To iGridMax Step 1
            Dim ordreAffichage As Integer = AntecedentDataGridView("ordreAffichage", i).Value
            Dim AntecedentId As Integer = CInt(AntecedentDataGridView("antecedentId", i).Value)
