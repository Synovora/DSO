...
Public Class ParametreOasisDao
    ...
    Friend Sub TraitementContexte()
        ...
        If CodeRetour = True Then
            ...
            For i = 0 To rowCount Step 1
                ...
                ContexteDao.TransformationEnAntecedent(contexteId, AntecedentHistoaCreer)
            Next
        End If
    ...
    Friend Function CreationParametre(Id As Integer, Description As String, dateValeur As Date) As Boolean
    ...
    Friend Function ModificationParametre(Id As Integer, dateValeur As Date) As Boolean
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim codeRetour As Boolean = True
        Dim con As SqlConnection
        con = GetConnection()
