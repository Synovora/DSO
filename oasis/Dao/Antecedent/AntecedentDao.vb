...
Public Class AntecedentDao
    ...
    Public Function AnnulationAntecedent(antecedentUpdate As Antecedent, antecedentRead As Antecedent) As Boolean
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim codeRetour As Boolean = True
    ...
    Public Function CreationAntecedent(antecedentUpdate As Antecedent) As Boolean
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim codeRetour As Boolean = True
