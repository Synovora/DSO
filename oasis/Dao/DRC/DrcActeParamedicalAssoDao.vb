...
Public Class DrcActeParamedicalAssoDao
    ...
    Friend Function getDrcActeParamedicalAssoById(Id As Integer) As DrcActeParamedicalAsso
    ...
    Friend Function CreateDrcActeParamedicalAsso(drcActeParamedicalAsso As DrcActeParamedicalAsso) As Boolean
    ...
    Friend Function SuppressionDrcActeParamedicalAsso(Id As Long) As Boolean
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim codeRetour As Boolean = True
