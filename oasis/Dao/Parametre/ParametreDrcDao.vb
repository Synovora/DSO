...
Public Class ParametreDrcDao
    ...
    Friend Function GetParametreDrcById(parametreId As Integer) As ParametreDrc
    ...
    Friend Function CreationParametreDrc(parametreDrc As ParametreDrc) As Boolean
    ...
    Friend Function ModificationParametreDrc(parametreDrc As ParametreDrc) As Boolean
    ...
    Friend Function SuppressionParametreDrcByDrcId(DrcId As Long) As Boolean
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim codeRetour As Boolean = True
        Dim con As SqlConnection = GetConnection()
    ...
    Friend Function getParametresByDrcId(DrcId As Long) As DataTable
