...
Public Class AllergieDao
    ...
    Friend Function GetAllergieSubstanceById(SubstanceId As Long) As Allergie
    ...
    Friend Function CreationAllergie(allergie As Allergie) As Boolean
    ...
    Friend Function AnnulationAllergie(allergieId) As Boolean
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim codeRetour As Boolean = True
        Dim n As Integer 'Pour récupérer le nombre d'occurences enregistrées
