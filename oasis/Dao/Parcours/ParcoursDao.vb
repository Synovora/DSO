...
Public Class ParcoursDao
    ...
    Friend Function ExistIntervenantByPatientId(patientId As Integer, categorieId As Integer, sousCategorieId As Integer, specialiteId As Integer) As Boolean
        Dim con As SqlConnection
        con = GetConnection()
    ...
    Friend Function AnnulationIntervenantParcours(parcours As Parcours) As Boolean
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim codeRetour As Boolean = True
        Dim con As SqlConnection = GetConnection()
    ...
    Friend Function Compare(source1 As Parcours, source2 As Parcours) As Boolean
