...
Public Class EpisodeActeParamedicalDao
    ...
    Friend Function GetEpisodeActeParamedicalById(episodeActeParamedicalId As Integer) As EpisodeActeParamedical
    ...
    Friend Function getAllEpisodeActeParamedicalByEpisodeId(episodeId As Long, Optional typeObservation As String = "PARAMEDICAL") As DataTable
        ...
        SQLString = "SELECT E.oa_episode_acte_paramedical_id," &
            ...
            " E.date_modification_observation, D.oa_drc_libelle, D.oa_drc_dur_prob_epis" &
    ...
    Friend Function PutAllEpisodeActeParamedicalToMedicalByEpisodeId(episodeId As Long) As Boolean
        Dim SQLString As String
    ...
    Friend Function ModificationEpisodeActeParamedicalObservation(episodeActeParamedicalId As Long, Observation As String) As Boolean
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim codeRetour As Boolean = True
        Dim con As SqlConnection = GetConnection()
    ...
    Friend Function SuppressionEpisodeActeParamedicalByEpisodeId(episodeId As Long) As Boolean
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim codeRetour As Boolean = True
        Dim con As SqlConnection = GetConnection()
