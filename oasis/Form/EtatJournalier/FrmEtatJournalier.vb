...
Public Class FrmEtatJournalier
    ...
    Private Sub ChargementPatient()
        ...
        For i = 0 To rowCount Step 1
            ...
            RadGridView.Rows(iGrid).Cells("dn").Value = Coalesce(patientDataTable.Rows(i)("oa_patient_nir"), "")
            RadGridView.Rows(iGrid).Cells("ins").Value = Coalesce(patientDataTable.Rows(i)("oa_patient_INS"), "")
