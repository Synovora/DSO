...
Public Class AutoSuiviDao
    ...
    Friend Function GetAutoSuiviByPatientIdAndParametreId(patientId As Long, parametreId As Long) As AutoSuivi
    ...
    Friend Function CreateAutoSuivi(autoSuivi As AutoSuivi) As Boolean
    ...
    Friend Function DeleteAutoSuivi(autoSuivi As AutoSuivi) As Boolean
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim codeRetour As Boolean = True
        Dim con As SqlConnection
        con = GetConnection()
