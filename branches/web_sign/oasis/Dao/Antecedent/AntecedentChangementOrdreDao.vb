...
Public Class AntecedentChangementOrdreDao
    ...
    Friend Function AntecedentReorganisationOrdre(niveau As Integer, selectedPatientId As Long, AntecedentIdPere As Long, NiveauAntecedentAOrdonner As Integer, Cacher As String) As Boolean
    ...
    Friend Function AffectationOrdreAntecedenetsLies(antecedentIdRef As Integer, niveau As Integer, OrdreAffichageRef As Integer, selectedPatientId As Long, NiveauAntecedentAOrdonner As Integer, Cacher As String)
        'Déclaration des données de connexion
        Dim CodeRetour As Boolean = True
