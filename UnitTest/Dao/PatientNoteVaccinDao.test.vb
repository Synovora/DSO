...
''' <summary>
''' Lecture d'une ligne par PatientNoteVaccinDao.BuildBean. Généré à partir du code : la liste des
''' colonnes et les valeurs de repli sont celles de la source, pas une reprise à la main.
''' </summary>
<TestClass()> Public Class TestPatientNoteVaccinDaoLecture
    ...
    <TestMethod()> Public Sub UneLigneCompleteEstLueChampParChamp()
        Dim b = PatientNoteVaccinDao.BuildBean(LigneDeTest.Ligne(Colonnes, New Dictionary(Of String, Object) From {
    ...
    Public Sub UneLigneSansNoteIdEstUneErreur()
        ...
        PatientNoteVaccinDao.BuildBean(LigneDeTest.Ligne(Colonnes, valeurs))
    End Sub
