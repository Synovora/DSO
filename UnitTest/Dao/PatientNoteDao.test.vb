...
''' <summary>
''' Lecture d'une ligne par PatientNoteDao.buildBean. Généré à partir du code : la liste des
''' colonnes et les valeurs de repli sont celles de la source, pas une reprise à la main.
''' </summary>
<TestClass()> Public Class TestPatientNoteDaoLecture
    ...
    <TestMethod()> Public Sub UneLigneCompleteEstLueChampParChamp()
        Dim b = PatientNoteDao.buildBean(LigneDeTest.Ligne(Colonnes, New Dictionary(Of String, Object) From {
    ...
    Public Sub UneLigneSansNoteIdEstUneErreur()
        ...
        PatientNoteDao.buildBean(LigneDeTest.Ligne(Colonnes, valeurs))
    End Sub
