...
''' <summary>
''' Lecture d'une ligne par EtatJournalierDao.BuildBean. Généré à partir du code : la liste des
''' colonnes et les valeurs de repli sont celles de la source, pas une reprise à la main.
''' </summary>
<TestClass()> Public Class TestEtatJournalierDaoLecture
    ...
    Private Shared ReadOnly Colonnes As String() = {
        ...
        "oa_drc_dur_prob_epis", "oa_drc_date_creation", "oa_drc_utilisateur_creation",
        "oa_drc_date_modification", "oa_drc_utilisateur_modification"}

    <TestMethod()> Public Sub UneLigneCompleteEstLueChampParChamp()
        Dim b = EtatJournalierDao.BuildBean(LigneDeTest.Ligne(Colonnes, New Dictionary(Of String, Object) From {
            {"oa_drc_id", 101},
            ...
            {"oa_drc_utilisateur_modification", 118L}}))
        ...
        Assert.AreEqual(118L, b.UserModification)
    End Sub
    ...
    Public Sub UneLigneSansDrcIdEstUneErreur()
        ...
        EtatJournalierDao.BuildBean(LigneDeTest.Ligne(Colonnes, valeurs))
    End Sub
