...
''' <summary>
''' Lecture d'une ligne par PatientNoteSocialeDao.buildBean. Généré à partir du code : la liste des
''' colonnes et les valeurs de repli sont celles de la source, pas une reprise à la main.
''' </summary>
<TestClass()> Public Class TestPatientNoteSocialeDaoLecture
    ...
    <TestMethod()> Public Sub UneLigneCompleteEstLueChampParChamp()
        Dim b = PatientNoteSocialeDao.buildBean(LigneDeTest.Ligne(Colonnes, New Dictionary(Of String, Object) From {
    ...
    Public Sub UneLigneSansNoteIdEstUneErreur()
        ...
        PatientNoteSocialeDao.buildBean(LigneDeTest.Ligne(Colonnes, valeurs))
    End Sub
