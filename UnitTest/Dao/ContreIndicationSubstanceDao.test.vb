...
''' <summary>
''' Lecture d'une ligne par ContreIndicationSubstanceDao.BuildBean. Généré à partir du code : la liste des
''' colonnes et les valeurs de repli sont celles de la source, pas une reprise à la main.
''' </summary>
<TestClass()> Public Class TestContreIndicationSubstanceDaoLecture

    Private Shared ReadOnly Colonnes As String() = {
        "contre_indication_id", "patient_id", "substance_id", "substance_pere_id",
        "denomination_substance", "denomination_substance_pere", "creation_user_id",
        "creation_date", "annulation_user_id", "annulation_date", "inactif"}

    <TestMethod()> Public Sub UneLigneCompleteEstLueChampParChamp()
        Dim b = ContreIndicationSubstanceDao.BuildBean(LigneDeTest.Ligne(Colonnes, New Dictionary(Of String, Object) From {
    ...
    Public Sub UneLigneSansContreIndicationIdEstUneErreur()
        ...
        ContreIndicationSubstanceDao.BuildBean(LigneDeTest.Ligne(Colonnes, valeurs))
    End Sub
