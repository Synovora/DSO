...
Public Class EpisodeObservationDao
    ...
    Public Function Compare(source1 As EpisodeObservation, source2 As EpisodeObservation) As Boolean
    ...
    Public Function CreateEpisodeObservation(episodeObservation As EpisodeObservation) As Boolean
    ...
    Public Function ModificationEpisodeObservation(episodeObservation As EpisodeObservation) As Boolean
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim codeRetour As Boolean = True
