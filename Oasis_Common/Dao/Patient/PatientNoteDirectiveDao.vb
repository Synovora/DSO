...
Public Class PatientNoteDirectiveDao
    Inherits StandardDao

    Public Function getAllNoteDirectivebyPatient(patientId As Integer) As DataTable
        Dim SQLString As String = "select * from oasis.oa_patient_note_directive where" &
    ...
    Public Function getNoteById(noteId As Integer) As PatientNote
        ...
        Try
            ...
            Using reader As SqlDataReader = command.ExecuteReader()
                ...
                Else
                    Throw New ArgumentException("Directive anticipée du patient inexistante !")
                End If
            End Using
    ...
    Public Function CreationNote(patientNote As PatientNote) As Boolean
        ...
        Dim SQLstring As String = "insert into oasis.oa_patient_note_directive" &
    ...
    Public Function ModificationNote(patientNote As PatientNote) As Boolean
        ...
        Dim SQLstring As String = "update oasis.oa_patient_note_directive set" &
    ...
    Public Function AnnulationNote(patientNote As PatientNote) As Boolean
        ...
        Dim SQLstring As String = "update oasis.oa_patient_note_directive set oa_patient_note_date_modification = @dateModification," &
