...
Public Class AntecedentAffectationDao
    ...
    Public Sub AntecedentModificationNiveau(antecedentId As Long, antecedentIdPere As Long, niveauActuel As Integer, niveauCible As Integer, antecedentId1 As Long, antecedentId2 As Long, ordre1 As Integer, ordre2 As Integer, ordre3 As Integer, SelectedPatient As Patient, Cacher As String)
    ...
    Public Function AntecedentReorganisationOrdre(AntecedentId As Integer, niveau As Integer, SelectedPatientId As Long, Cacher As String) As Boolean
    ...
    Public Function AffectationOrdreAntecedenetsLies(antecedentIdRef As Integer, niveau As Integer, OrdreAffichageRef As Integer, selectedPatientId As Long, Cacher As String) As Boolean
        'Déclaration des données de connexion
        Dim con As SqlConnection
        con = GetConnection()
    ...
    Public Function AffectationAntecedenetsLies(Traitement As Integer, antecedentIdaAffecter As Integer, antecedentIdCible As Integer, Ordre1 As Integer, selectedPatientId As Long, Cacher As String) As Boolean
        'Déclaration des données de connexion
        Dim con As SqlConnection
        con = GetConnection()
