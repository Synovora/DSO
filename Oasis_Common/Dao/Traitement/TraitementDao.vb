...
Public Class TraitementDao
    ...
    ''' <summary>
    ''' Lit une ligne de traitement telle quelle, sans toucher à la base.
    ''' IDataRecord plutôt que SqlDataReader pour qu'un test puisse fournir la ligne.
    ''' </summary>
    Public Shared Function BuildBean(record As System.Data.IDataRecord) As Traitement
        Dim traitement As New Traitement With {
            .TraitementId = record("oa_traitement_id"),
            .PatientId = Coalesce(record("oa_traitement_patient_id"), 0),
            .MedicamentId = Coalesce(record("oa_traitement_medicament_cis"), 0),
            .MedicamentDci = Coalesce(record("oa_traitement_medicament_dci"), ""),
            .ClasseAtc = Coalesce(record("oa_traitement_classe_atc"), ""),
            .DenominationLongue = Coalesce(record("oa_traitement_denomination_longue"), ""),
            .UserCreation = Coalesce(record("oa_traitement_identifiant_creation"), 0),
            .DateCreation = Coalesce(record("oa_traitement_date_creation"), Nothing),
            .UserModification = Coalesce(record("oa_traitement_identifiant_modification"), 0),
            .DateModification = Coalesce(record("oa_traitement_date_modification"), Nothing),
            ...
            .FenetreCommentaire = Coalesce(record("oa_traitement_fenetre_commentaire"), ""),
            .Commentaire = Coalesce(record("oa_traitement_commentaire"), ""),
            .Arret = Coalesce(record("oa_traitement_arret"), ""),
            .ArretCommentaire = Coalesce(record("oa_traitement_arret_commentaire"), ""),
            .Allergie = Coalesce(record("oa_traitement_allergie"), False),
            .ContreIndication = Coalesce(record("oa_traitement_contre_indication"), False),
            .DeclaratifHorsTraitement = Coalesce(record("oa_traitement_declaratif_hors_traitement"), False),
            .Annulation = Coalesce(record("oa_traitement_annulation"), ""),
            .AnnulationCommentaire = Coalesce(record("oa_traitement_annulation_commentaire"), "")
        }
        Return traitement
    End Function
