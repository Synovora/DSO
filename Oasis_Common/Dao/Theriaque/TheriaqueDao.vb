...
Public Class TheriaqueDao
    ...
    Public Function GetSpecialiteById(SpecialiteId As Integer) As SpecialiteTheriaque
    ...
    Public Function GetATCListeByATCPere(CodeATC As String) As DataTable
    ...
    Public Function GetATCDenominationById(CodeId As String) As String
        Dim dt As New DataTable
        Dim ds As New DataSet
    ...
    '   Spécialité
    '=============================================================================================
    Public Function GetSpecialiteByArgument(CodeId As String, VarTyp As EnumGetSpecialite, Monovir As Integer) As DataTable
        Dim dt As New DataTable
        Dim ds As New DataSet
    ...
    Public Function GetSpecialiteDenominationById(CodeId As String) As String
        Dim dt As New DataTable
        Dim ds As New DataSet
    ...
    Public Function GetCodeAtcBySpecialiteId(CodeId As String) As String
        Dim dt As New DataTable
        Dim ds As New DataSet
    ...
    Public Function GetPharmacoCinetiqueBySpecialite(CodeId As String) As String
        Dim dt As New DataTable
        Dim ds As New DataSet
    ...
    Public Function GetEffetIndesirableBySpecialite(CodeId As String, Type As EnumTypeEffetIndesirable) As String
        Dim dt As New DataTable
        Dim ds As New DataSet
    ...
    Public Function GetPharmacoDynamiqueBySpecialite(CodeId As String) As String
        Dim dt As New DataTable
        Dim ds As New DataSet
    ...
    '   Substance père
    '=============================================================================================
    Public Function GetSubstancePereDenominationById(substancePereId As Integer) As String
    ...
    '   Substance
    '=============================================================================================
    Public Function GetSubstanceById(CodeId As String) As Substance
        Dim dt As New DataTable
        Dim ds As New DataSet
    ...
    Public Function GetSubstanceCodeListBySpecialite(CodeId As String) As List(Of Integer)
        Dim dt As New DataTable
        Dim ds As New DataSet
    ...
    Public Function GetSubstanceDenominationById(CodeId As String) As String
        Dim dt As New DataTable
        Dim ds As New DataSet
    ...
    Public Function GetATCCodeListBySubstanceId(SubstanceId As String) As List(Of String)
        Dim dt As New DataTable
        Dim ds As New DataSet
    ...
    '=============================================================================================
    Public Function IsSpecialiteContreIndique(patient As PatientBase, specialiteId As Long) As SpecialiteContreIndique
    ...
    '=== Contrôle allergie
    '=============================================================================================
    Public Function IsSpecialiteAllergique(patient As PatientBase, specialiteId As Long) As SpecialiteAllergique
