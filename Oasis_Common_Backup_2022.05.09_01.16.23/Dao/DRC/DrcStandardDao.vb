...
Public Class DrcStandardDao
    ...
    Public Function GetDrcStandardById(drcStandardId As Integer) As DrcStandard
    ...
    Public Function CreationDrcStandard(drcStandard As DrcStandard) As Boolean
    ...
    Public Function SuppressionDrcStandard(Id As Long) As Boolean
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim codeRetour As Boolean = True
        Dim con As SqlConnection = GetConnection()
