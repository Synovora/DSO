...
Public Class EpisodeContexteDao
    ...
    Public Function GetAllEpisodeContexteByEpisodeId(episodeId As Long) As DataTable
    ...
    Public Function GetEpisodeById(episodeContexteId As Integer) As EpisodeContexte
    ...
    Public Function SuppressionEpisodeContexteById(episodeContexteId As Long) As Boolean
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim codeRetour As Boolean = True
