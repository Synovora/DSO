Public Class Siege
    ...
    Public Property SiegeAdresse2 As String
    Public Property SiegeVille As String
    Public Property SiegeCodePostal As String
    Public Property SiegeTelephone As String
