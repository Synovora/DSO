    ...
    <div class="card d-md-flex overflow-hidden g-col-8">
        <div class="card-header bg-soft-primary">
            <div class="text-primary">
                ...
                <p>Profil Patient Nº @Request.Cookies("patientId").Value</p>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-sm-8 mt-4">
                    <p class="font-size-14 text-muted">Date de naissance: <span class="text-info">@String.Format(ViewBag.Patient.PatientDateNaissance, "dd/MM/yyyy")</span></p>
                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        @For i As Integer = 0 To ViewBag.Connections.Count - 1
                            @<tr>
                                <td>@System.DateTime.Now.ToString("dddd d MMM yyyy à HH\hmm", CultureInfo.GetCultureInfoByIetfLanguageTag("fr-FR"))</td>
                            </tr>
                        Next
                    </tbody>
                </table>
...
<div class="grid">
        ...
        <div class="card g-col-6">
            <h4 class="card-header mb-4">Mon Auto-Suivi</h4>
            <div class="card-body">
                <p class="text-muted">
        ...
        <div class="card g-col-6">
            <h4 class="card-header mb-4">Mes Vaccins</h4>
            <div class="card-body">
                <p class="text-muted">
        ...
        <div class="card g-col-6">
            <h4 class="card-header mb-4">Mes Rendez-Vous</h4>
            <div class="card-body">
                <p class="text-muted">
        ...
        <div class="card g-col-6">
            <h4 class="card-header mb-4">Mes Résultats</h4>
            <div class="card-body">
                <p class="text-muted">
