                                ...
                                <div Class="p-2">
                                    <form Class="form-horizontal" action="@Url.Action("Index")" method="post">
                                        ...
                                        <div Class="form-group">
                                            ...
                                            @Html.LabelFor(Function(modelItem) modelItem.Password)
                                            <div Class="col-md-10">
                                                @Html.EditorFor(Function(modelItem) modelItem.Password)
                                                @Html.ValidationMessageFor(Function(modelItem) modelItem.Password, "")
                                            </div>
                                        </div>
